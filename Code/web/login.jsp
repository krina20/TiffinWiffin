						...
						<li><a href="contact.jsp">Contact</a></li>
						 ...
						 <li class="has-dropdown"><a href="signup.jsp">Sign Up</a>
								...
								<li><a href="login.jsp">Login</a></li>
                                                ...
                                                <li class="btn-cta"><a  onclick="signOut();" href="SignOut">Sign Out</a></li>
                                                <%
                                                    }
                                                %>
				...
				<div class="col-md-12 col-md-offset-0 text-left">
					<div class="row row-mt-15em">
						<div class="col-md-7 mt-text animate-box" data-animate-effect="fadeInUp">
							<h1 class="cursive-font">Welcome to TiffinWiffin</h1>	
						</div>
												...
												<div class="row form-group">
													<div class="col-md-12">
														<input type="submit" class="btn btn-primary btn-block" value="Login">
                                                                                                    ...
                                                                                                    <div id="page">
                                                                                                        <input type="hidden" formaction="GoogleLogin" >
                                                                                                    <div class="g-signin2" data-width="285" data-height="50" data-longtitle="true" style="margin: 10px;" data-onsuccess="onSignIn"></div>
                                                                                                    </input>
                                                                                               <a class="logout" onclick="signOut();" href="SignOut" >Sign out</a> 
