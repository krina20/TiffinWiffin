		...
		<div class="gtco-container">
			...
			<div class="row">
				<div class="col-sm-4 col-xs-12">
					<div id="gtco-logo"><a href="adminLogin.jsp">Tiffin Wiffin <em>.</em></a></div>
			</div>
				...
				<div class="col-md-12 text-center">
					<div class="gtco-widget">
						...
						<ul class="gtco-quick-contact">
							<li><a href="#"><i class="icon-phone"></i> +91 9090909090</a></li>
							<li><a href="#"><i class="icon-mail2"></i> info@TiffinWiffin.co</a></li>
