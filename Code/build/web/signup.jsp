                                                    ...
                                                    <form action="SignupServlet" method="POST">
                                                        <div class="row form-group">
                                                            <div class="col-md-12">
                                                                ...
                                                                <input type="text" name="name" class="form-control" placeholder="Your firstname" required="">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row form-group">
                                                            ...
                                                            <div id="page">
                                                                ...
                                                                <input type="hidden" formaction="GoogleSignup" >
                                                               <div class="g-signin2" data-width="285" data-height="50" data-longtitle="true" style="margin: 10px;" data-onsuccess="onSignUp"></div>
