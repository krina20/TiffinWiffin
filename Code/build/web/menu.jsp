		...
		<div class="gtco-container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center gtco-heading">
					<h2 class="cursive-font primary-color">This month's menu</h2>
				</div>
			</div>
                    
                   <div class="col-lg-4 col-md-4 col-sm-6">
                       <a href="images/December_guj_menu.jpg" class="fh5co-card-item image-popup">
						<figure>
							<div class="overlay"><i class="ti-plus"></i></div>
                                                        <img src="images/gujarati.jpg" alt="December Gujarati Menu" class="img-responsive">
						</figure>
					</a>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-6">
                                    <a href="images/December_pun_menu.jpg" class="fh5co-card-item image-popup">
						<figure>
							<div class="overlay"><i class="ti-plus"></i></div>
                                                        <img src="images/punjabi.jpg" alt="December Gujarati Menu" class="img-responsive">
						</figure>
					</a>
				</div>
		</div>
