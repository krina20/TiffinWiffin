					...
					<div class="row row-mt-15em">
						<div class="col-md-12 mt-text animate-box" data-animate-effect="fadeInUp">
                                                    <h1 class="cursive-font">All in good taste!</h1>
                                                        <p>Let's eat healthy and yummy food daily</p>	
						</div>
					</div>
				</div>
			</div>
		...
		<div class="gtco-container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center gtco-heading">
					<h2 class="cursive-font primary-color">Our Packages</h2>
				</div>
			</div>
			<div class="row">
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="images/img_1.jpg" class="fh5co-card-item image-popup">
						<figure>
							...
							<img src="images/img_1.jpg" alt="Monthly - Gujarati" class="img-responsive">
						</figure>
						<div class="fh5co-text">
							<h2>Monthly - Gujarati</h2>
							<p><span class="price cursive-font">Rs.1800</span></p>
						</div>
					</a>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="images/img_2.jpg" class="fh5co-card-item image-popup">
						<figure>
							<div class="overlay"><i class="ti-plus"></i></div>
							<img src="images/img_2.jpg" alt="Weekly - Gujarati" class="img-responsive">
						</figure>
						<div class="fh5co-text">
							<h2>Weekly - Gujarati</h2>
							<p><span class="price cursive-font">Rs.450</span></p>
						</div>
					</a>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="images/img_3.jpg" class="fh5co-card-item image-popup">
						<figure>
							<div class="overlay"><i class="ti-plus"></i></div>
							<img src="images/img_3.jpg" alt="Daily - Gujarati" class="img-responsive">
						</figure>
						<div class="fh5co-text">
							<h2>Daily - Gujarati</h2>
							<p><span class="price cursive-font">Rs.80</span></p>
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="images/img_4.jpg" class="fh5co-card-item image-popup">
						<figure>
							<div class="overlay"><i class="ti-plus"></i></div>
							<img src="images/img_4.jpg" alt="Monthly - Punjabi" class="img-responsive">
						</figure>
						<div class="fh5co-text">
							<h2>Monthly - Punjabi</h2>
							<p><span class="price cursive-font">Rs.1900</span></p>
						</div>
					</a>
				</div>
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="images/img_5.jpg" class="fh5co-card-item image-popup">
						<figure>
							<div class="overlay"><i class="ti-plus"></i></div>
							<img src="images/img_5.jpg" alt="Weekly - Punjabi" class="img-responsive">
						</figure>
						<div class="fh5co-text">
							<h2>Weekly - Punjabi</h2>
							<p><span class="price cursive-font">Rs.500</span></p>
						</div>
					</a>
				</div>
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="images/img_6.jpg" class="fh5co-card-item image-popup">
						<figure>
							<div class="overlay"><i class="ti-plus"></i></div>
							<img src="images/img_6.jpg" alt="Daily - Punjabi" class="img-responsive">
						</figure>
						<div class="fh5co-text">
							<h2>Daily - Punjabi</h2>
							<p><span class="price cursive-font">Rs.90</span></p>
						</div>
					</a>
				</div>
			...
			<div class="row">
				...
				<div class="col-md-4 col-sm-6">
					<div class="feature-center animate-box" data-animate-effect="fadeIn">
						...
						<h3>Food Delivery</h3>
						<p>Get way too much happiness from good food!</p>
					</div>
				</div>
